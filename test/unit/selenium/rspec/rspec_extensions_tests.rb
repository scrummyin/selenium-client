...
unit_tests do
  ...
  test "Example reporting_uid is the same when example is the same" do
    example_class = RSpec::Core::Example
    example = example_class.new(:a_proxy,"Test","Fake Test") do puts "some implementation" end
  ...
  test "Example reporting_uid are not equals when implementation is different" do
    example_class = RSpec::Core::Example
    first_example = example_class.new(:a_proxy,"Test","Fake Test") do puts "some implementation" end
    second_example = example_class.new(:a_proxy,"Test","Fake Test") do puts "another implementation" end
